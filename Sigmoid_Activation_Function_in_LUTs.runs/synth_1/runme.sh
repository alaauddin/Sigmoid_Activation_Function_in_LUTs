...
HD_PWD='C:/Users/User/ACTIVATION FUNCTION/Sigmoid_Activation_Function_in_LUTs/Sigmoid_Activation_Function_in_LUTs.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sigmoid_in_LUTs.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sigmoid_in_LUTs.tcl
